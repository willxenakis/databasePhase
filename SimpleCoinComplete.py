...
class Block(object):
    prevHash = None
    currHash = None
    def __init__(self, data, index = 0, prevBlock = None, nextBlock = None, nonce=0, timeStamp=None, merkleRoot=None, prevHash=None, currHash=None):
        self.index = index
        self.data = data
        self.nonce = nonce
...
class blockChain(object):
    def __init__(self, creator, head=None, tail=None, difficulty = 2):
    ...
    def addBlockManual(self, newTailBlock):
        self.tail.nextBlock = newTailBlock
        self.tail = newTailBlock
